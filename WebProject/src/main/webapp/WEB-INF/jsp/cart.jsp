...
<c:if test="${not empty cart.getProducts()}">
    <h4 class="site-heading text-center text-white d-none d-lg-block" id="cartHeader">
        <span class="site-heading-upper">Items in the shopping cart: </span>
    </h4>
</c:if>

<script src="https://use.fontawesome.com/c560c025cf.js"></script>
<c:choose>
    <c:when test="${not empty cart.getProducts()}">
                ...
                <div class="card shopping-cart">
                            ...
                            <div class="row" id="divEl${count.index + 1}" value="${mapItem.id}">
                                ...
                                <div class="col-12 col-sm-12 text-sm-center col-md-4 text-md-right row">
                                    <div class="col-3 col-sm-3 col-md-6 text-md-right" style="padding-top: 5px">
                                        <h6><strong>${mapItem.price}<span class="text-muted"> x</span></strong></h6>
                                    </div>
                                    <div class="col-4 col-sm-4 col-md-4">
                                        <div class="quantity">
                                            <input type="number" step="1" max="99" min="1"
                                                   ...
                                                   size="4" name="ItemQuantity${count.index + 1}" onclick="changeItemQuantity(this)">
                                        </div>
                                    </div>
                    ...
                    <div class="card-footer">
                        ...
                        <div class="pull-right" style="margin: 10px">
                            <form method="GET" action="order" class="pull-right">
                                <input type="hidden" value="${user}" id="sessionUser">
                                <input class="btn btn-success pull-right" value="Checkout" type="button"
                                       onclick="checkUserAuthentication(this.form)">
                            </form>
    ...
    <c:otherwise>
        <h4 class="site-heading text-center text-white d-none d-lg-block" id="emptyCartMsg">
            <span class="site-heading-upper">No items in the shopping cart </span>
        </h4>
    </c:otherwise>
</c:choose>
